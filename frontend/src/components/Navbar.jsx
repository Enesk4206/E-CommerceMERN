                ...
                <div className="flex flex-wrap justify-between items-center">
                    ...
                    <nav className="flex flex-wrap items-center gap-4">
					 ...
					 ease-in-out'>
                        ...
                        {user && (
                            <Link to={"/cart"} className="relative group className='text-gray-300 hover:text-emerald-400 transition duration-300
                        ease-in-out'">
                        ...
                        {user ? (
                            <button className='bg-gray-700 hover:bg-gray-600 text-white py-1 px-4 
