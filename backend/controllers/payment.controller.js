...
export const createCheckoutSession = async(req,res) =>{
    try {
        ...
        const lineItems = products.map(product =>{
            const amount = Math.round(product.price * 100);  // stripe work with cents
...
const createNewCoupon =  async function (userId){
...
export const paymentCheckoutSuccess = async(req,res) =>{
    try {
        ...
        console.log("Error processing in payment controller", error);
